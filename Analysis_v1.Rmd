...
### Current Issues
* Under current version of app (v2.7) and the Rfacebook package, there is no method of getting other friends' information or public profiles, unless they are using the app -- need to find another way of getting this information 
...
* Find publicly available sources regarding other Gail Score criteria
* Learn more about how the underpinnings of the Gail Score
    + How does the existing tool weight each of the variables